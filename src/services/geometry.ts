 ...
 */
export function destinationPoint(lat: number, lon: number, distanceKm: number, bearing: number): LatLon {
 ...
 */
export function calculateBearing(fromLat: number, fromLon: number, toLat: number, toLon: number): number {
