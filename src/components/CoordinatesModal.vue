        ...
        <div>
          ...
          <div v-else class="d-flex flex-column gap-2" style="max-height: 300px; overflow-y: auto;">
            <div
              ...
              style="background-color: rgba(59, 130, 246, 0.05); border: 1px solid rgba(59, 130, 246, 0.1);"
            >
...
<script lang="ts" setup>
  ...
  async function saveAndAddAsPoint () {
    ...
    if (drawing) {
      ...
      uiStore.addToast('Coordinate saved (but point creation failed - drawing not available)', 'info')
    }
